...
class _LoginState extends State<Login> {
  ...
  login() async {
    final response = await http.post("https://120999.000webhostapp.com/koneksi/login.php",
...
//      nama = preferences.getString("nama");
  ...
  Future<List> getData() async {
    final response = await http.get("https://120999.000webhostapp.com/koneksi1/getPegawai.php");
